...
$q= "select 
       ...
       FROM txn left join txn_line on txn.id = txn_line.txn left join item on txn_line.item = item.id where type = 'customer' and ($sql_criteria) and paid between '2012-06-01' and '2013-01-01' group by 1";
