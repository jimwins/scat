...
function formatMethod(payment) {
  ...
  } else if (payment.method() == 'credit' || payment.method() == 'stripe') {
...
<form id="pay-other" class="pay-method" style="display: none">
 ...
 <button class="btn btn-default" data-value="postmates">Postmates</button>
    ...
    <tr class="item" valign="top"
      ...
      <td align="center" class="editable"
          data-bind="visible: $parent.showAllocated(),
                     css: {
                       danger: $parent.txn.type() == 'vendor' && $data.quantity() != $data.allocated(),
                       over: $data.allocated() > $data.quantity()
                     }">
