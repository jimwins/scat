...
#SKU	UPC	Retail Price	Wholesale Price	Quantity Available	Description	Brand	Minimum Sell	Case Pack	Freight Collect
  ...
  public function checkVendorStock(\Scat\Model\VendorItem $vendor_item) {
    ...
    case 7: // Mac
      return check_mac_stock($vendor_item->vendor_sku);
    case 3757: // SLS
      return check_sls_stock($vendor_item->vendor_sku);
    case 30803: // PA Dist
      return check_padist_stock($vendor_item->vendor_sku);
    case 44466: // Notions
      return check_notions_stock($vendor_item->vendor_sku);
    default:
